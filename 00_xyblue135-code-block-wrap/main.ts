...
export default class CodeBlockWrapTogglePlugin extends Plugin {
  ...
  private syncEditorCodeBlockScrollbars(): void {
    ...
    document.querySelectorAll<HTMLElement>('body > .xyblue135-codeblock-scrollbar-overlay').forEach((scrollbar) => {
  ...
  onunload(): void {
    ...
    document.querySelectorAll<HTMLElement>('body > .xyblue135-codeblock-scrollbar-overlay').forEach((el) => el.remove());
  }
}
