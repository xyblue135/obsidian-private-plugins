...
class CodeBlockWrapTogglePlugin extends obsidian_1.Plugin {
    ...
    syncEditorCodeBlockScrollbars() {
        ...
        document.querySelectorAll('body > .xyblue-codeblock-scrollbar-overlay').forEach((scrollbar) => {
    ...
    onunload() {
        ...
        document.querySelectorAll('body > .xyblue-codeblock-scrollbar-overlay').forEach((el) => el.remove());
    }
}
